...
## eliminated the observation "District of columbia"
Opioid_deaths = Opioid_deaths[Opioid_deaths['Location']!="District of Columbia"]
...
## Re-names Age adjusted rate to AAR to allow for codeability:
